...
public record RemoteSyncPayload(String blockId) implements CustomPayload {
public static final Id<RemoteSyncPayload> ID = new Id<>(Identifier.of(AmenityCraft.MOD_ID, "remote_sync"));
public static final PacketCodec<RegistryByteBuf, RemoteSyncPayload> CODEC = PacketCodec.tuple(net.minecraft.network.codec.PacketCodecs.STRING, RemoteSyncPayload::blockId, RemoteSyncPayload::new);
@Override 
